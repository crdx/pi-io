...
**Custom providers & models:** Add providers via `~/.pi/agent/models.json` if they speak a supported API (OpenAI Chat Completions, OpenAI Responses, Anthropic Messages). For custom APIs or OAuth, use extensions. See [docs/models.md](docs/models.md) and [docs/custom-provider.md](docs/custom-provider.md).
...
Place in `~/.pi/agent/extensions/` or `.pi/extensions/`. See [docs/extensions.md](docs/extensions.md).
