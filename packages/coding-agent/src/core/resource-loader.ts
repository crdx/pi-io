...
/** A context file (AGENTS.md and friends) and its contents. */
...
const LOCAL_CONTEXT_FILE_NAMES = ["AGENTS.local.md", "CLAUDE.local.md"];
...
export class DefaultResourceLoader implements ResourceLoader {
	...
	async reload(): Promise<void> {
		...
		time("  reload: packageManager.resolve");
		...
		time("  reload: loadExtensions");

		const inlineExtensions = await this.loadExtensionFactories(extensionsResult.runtime);
		time("  reload: extension factories");
