...
const MIGRATION_GUIDE_URL =
	"https://github.com/crdx/pi-io/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/crdx/pi-io/blob/main/packages/coding-agent/docs/extensions.md";
