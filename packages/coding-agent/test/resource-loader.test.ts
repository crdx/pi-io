...
Content`,
	...
	describe("context files", () => {
		// Relative paths of the loaded context files, in load order, ignoring any real
		// context files found while walking up from the temp dir to the filesystem root.
